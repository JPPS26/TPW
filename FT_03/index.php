...
<head>
	<title>WAMPSERVER - Col&eacute;gio de Gaia - Homepage</title>
...
<body>
	<div id="head"></div>
	<div style="position:absolute; top:30px; left:160px;"><img src="/colgaia.png" /></div>



	<h2>Ferramentas</h2>
	<ul class="tools">
		<li><a href="##URL##/?phpinfo=1" target="_blank">phpinfo()</a></li>
		<li><a href="##URL##/phpmyadmin/" target="_blank">phpmyadmin</a></li>
	</ul>
	<h2>Projectos desenvolvidos</h2>
	<ul class="projects">
	$projectContents
	</ul>
	...
	<ul id="foot">
		<li><a href="http://www.wampserver.com">WampServer</a></li> | 
        	<li><a href="http://www.colgaia.pt" target="_blank">Colégio de Gaia</a></li>
	</ul>
...
echo str_replace('##URL##', 'http://'.$_SERVER['HTTP_HOST'], $pageContents);
?>
